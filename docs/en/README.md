...
- 🔄 **Workflow State Machine**: Status transitions (`not_started → submitted → approved`) with Submit/Approve/Reset/Reopen actions
...
- [Document Workflow Guide](../DOCUMENT_WORKFLOW_GUIDE.md) - Deadline calculation logic and hybrid layout usage guide
